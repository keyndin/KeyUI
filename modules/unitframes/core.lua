...
local TEXTURE = [[Interface\AddOns\KeyUI\media\statusbar]]
...
local PostCreateIcon = function(Auras, button)
	...
	addon.CreateBorder(button, [[Interface\AddOns\KeyUI\media\glow]])
...
local Shared = function(self, unit, isSingle)
	...
	addon.CreateBorder(self, [[Interface\AddOns\KeyUI\media\glow]])
